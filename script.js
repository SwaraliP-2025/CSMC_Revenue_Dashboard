...
var FY_DATA = {
  "2025-26": {
    ...
    misc: {
      ...
      "misc-building":  { label:"Building, Urban Planning & Development",   icon:"🏗️", color:"#0d4f8a",
      ...
      "misc-sanitation":{ label:"Sanitation, Environment & Waste",          icon:"♻️", color:"#0a6b3a",
...
var MISC_SUB_SERVICES = {
  "misc-water": [
    ...
    "Change of Water Connection Ownership",
    "Change in Water Usage Type",
    "Change in Connection Size",
    "New Plumber License",
    "Renewal of Plumber License",
    "Tanker Water Supply Charges (पाणी विक्री टॅंकर भाडे)",
    "Fines for Water Wastage / Illegal Connection",
    "New Drainage Connection Fees",
    "Drainage Advance Payments",
    "Treated Sewage Water Fees",
    "Drainage Regularization Charges",
    "Water Meter Testing Fees"
  ],
  "misc-health": [
    "OPD Fees — Shivaji Nagar Dispensary",
    "OPD Fees — Satara Dispensary",
    "OPD Fees — Saadat Nagar Dispensary",
    "OPD Fees — Cidco N-11 Dispensary",
    "OPD Fees — Cidco N-8 Dispensary",
    "OPD Fees — Silk Mill Colony Dispensary",
    "OPD Fees — Harsh Nagar Dispensary",
    "OPD Fees — Harsul Dispensary",
    "OPD Fees — Kabir Nagar Dispensary",
    "OPD Fees — Jinsi (New) Dispensary",
    "OPD Fees — Misarwadi Dispensary",
    "Slaughterhouse Fees (कत्तल खाना)",
    "Cattle Pound Fees (कोंडवाडा फी)",
    "New Pet License / Renewal (Animal Husbandry)"
  ],
  "misc-building": [
    ...
    "Gunthewari Development Charges (वसुली / विकास कामे)",
    "Zone Certificate Fees",
    "Refund of Security Deposit (Town Planning)",
    "Issuance of Part Plan",
  ...
  "misc-licensing": [
    ...
    "Trade License Name / Type Change",
    "Trade License Duplicate Copy",
    "Owner / Partner Change in License",
    "Trade License Cancellation",
    "NOC for Trade / Business",
    "NOC for Mandap / Wedding Hall",
    "Licensing of Lodging House / Renewal",
    "Hawkers License (NULM)",
    "Mobile Tower License",
    "Advertisement / Hoarding Board Fees (जाहीराती बोर्ड)"
  ],
  "misc-sanitation": [
    "Solid Waste Management Fines & Fees (नागरी घन कचरा व्‍यवस्‍थापन)",
    "Bio-Medical Waste Registration Fees (नोंदणी फी)",
    "Bio-Medical Waste Disposal Charges",
    "Sale of Trees & Flowers (झाडे व फुले विक्री)",
    "Tree Trimming / Felling Charges",
    "Environmental Compliance Fees"
  ],
  "misc-parks": [
    "Playground Rent (क्रिडांगन भाडे)",
    "Theater / Natyagriha Rent (नाट्यगृह भाडे)",
    "Building Rent (इमारत भाडे)",
    "Land / Stall Rent (जमीन भाडे / टपरी भाडे)",
    "Swimming Pool Membership Fees",
    "Zoo Entry Fees (प्राणी संग्रहालय)",
    "Aquarium Entry Fees (मत्स्यालय)",
    "Adventure Park Royalty (Chhatrapati Sambhaji Maharaj)",
    "Sports Complex Booking Fees",
    "Cultural Event Permissions",
    "Tourism Site Entry Fees",
    "Garden / Park Maintenance Charges",
    "Amphitheater Booking Fees",
    "Heritage Site Fees",
    "Photography / Filming Permissions",
    "Kiosk / Stall Rent in Parks"
  ],
  "misc-transport": [
    "Parking Fees (Municipal Parking Lots)",
    "Towing / Impound Charges",
    "Traffic Violation Fines (Municipal)",
    "Ambulance & Vehicle Charges",
    "Road Cutting / Restoration Charges"
  ],
  "misc-finance": [
    "GST — CGST 1% Collection",
    "GST — SGST 1% Collection",
    "GST — CGST 6% Collection",
    "GST — SGST 6% Collection",
    "GST — CGST 9% Collection",
    "GST — SGST 9% Collection",
    "State Government Grants (राज्य शासन अनुदान)",
    "Central Government Grants (केंद्र शासन अनुदान)",
    "Smart City / AMRUT Grants",
    "Property Transfer Fees",
    "Property Extract Fees",
    "NA Tax (Non-Agricultural Tax)",
    "Tender Form Fees (टेंडर फोर्म)",
    "Security Deposit Forfeiture",
    "Miscellaneous Fines & Penalties",
    "Court Fee Recovery",
    "Lease Rent — Municipal Properties",
    "Lease Rent — Commercial Shops",
    "Lease Rent — Residential Quarters",
    "Interest on Delayed Payments",
    "Surcharge on Arrears",
    "Refund Adjustments",
    "Fire NOC Fees (Provisional / Final / Renewal)",
    "Fire Call Charges",
    "Fire Fund (अग्नीशमन निधी)",
    "Marriage Registration Fees (विवाह नोंदणी)",
    "Birth Certificate Fees",
    "Death Certificate Fees",
    "Road Construction / Repair Grants (रस्ते बांधणी व दुरुस्ती अनुदान)",
    "Miscellaneous Receipts & Other Income"
  ]
};
